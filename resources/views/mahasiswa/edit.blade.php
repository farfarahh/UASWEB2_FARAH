                        ...
                        <div class="form-group">
                            <div class="form-row">
                                <div class="col">
                                    ...
                                    <input type="date" name="tanggal_lahir" class="form-control" placeholder="Tambahkan Tanggal" value="{{ is_null ($mahasiswa) ? '' : $mahasiswa->tanggal_lahir }}">
                                </div>
                                <div class="col">
                                   ...
                                   <select name="gender" id="gender" class="form-control">
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="number" name="telephone" class="form-control" placeholder="Tambahkan nomor telepon" value="{{ is_null ($mahasiswa) ? '' : $mahasiswa->telephone }}">
                                    </div>
                            </div>
                        </div>
